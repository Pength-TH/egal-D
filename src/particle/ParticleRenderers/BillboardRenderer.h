	...
	class _ParticleUniverseExport BillboardRenderer : public ParticleRenderer
	{
		public:
			...
			*/
			...
			static const bool DEFAULT_COMMON_DIRECTION_LOCAL;
			static const bool DEFAULT_COMMON_UP_VECTOR_LOCAL;
			...
			*/
			...
			/**
			*/
			void setCommonDirectionLocal(bool bFlag);
			/**
			*/
			const bool& getCommonDirectionLocal() const;
			...
			*/
			...
			/**
			*/
			void setUpVectorLocal(bool bFlag);
			/**
			*/
			const bool& getUpVectorLocal() const;
