...
#undef GL_GET
	...
	//			else
		...
		void requestScreenShot(FrameBufferHandle _handle, const char* _filePath) override
		{
			...
			{
				bimg::imageSwizzleBgra8(data, width, height, width*4, data, 0);
			}
		...
		void capture()
		{
			if (NULL != m_capture)
			{
				...
				if (GL_RGBA == m_readPixelsFmt)
				{
					bimg::imageSwizzleBgra8(m_capture, m_resolution.m_width, m_resolution.m_height, m_resolution.m_width*4, m_capture,0);
				}
