#ifndef ANIMATION_RUNTIME_BLENDING_JOB_H_
#define ANIMATION_RUNTIME_BLENDING_JOB_H_
...
namespace egal
{
	...
	namespace animation
	{
		...
		struct BlendingJob
		{
			...
			Range<const egal::math::SoaTransform> bind_pose;
			...
			Range<egal::math::SoaTransform> output;
		};
	}  // namespace animation
}  // namespace egal
#endif  // ANIMATION_RUNTIME_BLENDING_JOB_H_
