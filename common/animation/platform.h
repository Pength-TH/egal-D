...
#define JOIN(_a, _b) _JOIN(_a, _b)
// Compile time string concatenation implementation details.
#define _JOIN(_a, _b) _JOIN2(_a, _b)
#define _JOIN2(_a, _b) _a##_b
...
// Syntax is: "ALIGN(16) int i;" which aligns "i" variable address to 16
// bytes.
#if defined(_MSC_VER)
...
// compiler analysis.
// Syntax is: "INLINE void function();"
#if defined(_MSC_VER)
...
// Syntax is: "NO_INLINE void function();"
#if defined(_MSC_VER)
...
// Syntax is: void function(int* RESTRICT _p);"
