...
#ifndef ANIMATION_RUNTIME_SAMPLING_JOB_H_
#define ANIMATION_RUNTIME_SAMPLING_JOB_H_
...
namespace egal
{
	...
	namespace animation
	{
		...
		public:
			...
			int max_tracks() const
			{
				return max_soa_tracks_ * 4;
			}
			int max_soa_tracks() const
			{
...
#endif  // ANIMATION_RUNTIME_SAMPLING_JOB_H_
