#ifndef MATHS_GTEST_MATH_HELPER_H_
#define MATHS_GTEST_MATH_HELPER_H_
...
// Macro for testing egal::math::Float4 members with x, y, z, w float values,
...
do
{
	\
		SCOPED_TRACE("");                               \
		const egal::math::Float4 expected(_expected);    \
...
// Macro for testing egal::math::Float3 members with x, y, z float values,
// using EXPECT_FLOAT_EQ internally.
...
do
{
	\
		SCOPED_TRACE("");                            \
		const egal::math::Float3 expected(_expected); \
		ExpectFloatNear(expected.x, _x);             \
		ExpectFloatNear(expected.y, _y);             \
		ExpectFloatNear(expected.z, _z);             \
} while (void(0), 0)
...
// Macro for testing egal::math::Float2 members with x, y float values,
...
do
{
	\
		SCOPED_TRACE("");                            \
		const egal::math::Float2 expected(_expected); \
		ExpectFloatNear(expected.x, _x);             \
		ExpectFloatNear(expected.y, _y);             \
} while (void(0), 0)


// Macro for testing egal::math::Quaternion members with x, y, z, w float value.
#define EXPECT_QUATERNION_EQ(_expected, _x, _y, _z, _w) \
do
{
	\
		SCOPED_TRACE("");                                   \
		const egal::math::Quaternion expected(_expected);    \
		ExpectFloatNear(expected.x, _x);                    \
		ExpectFloatNear(expected.y, _y);                    \
		ExpectFloatNear(expected.z, _z);                    \
		ExpectFloatNear(expected.w, _w);                    \
...
// Macro for testing egal::math::simd::SimdFloat members with x, y, z, w values.
#define EXPECT_SIMDFLOAT_EQ(_expected, _x, _y, _z, _w)  \
do
{
	\
		SCOPED_TRACE("");                                   \
		const egal::math::SimdFloat4 expected(_expected);    \
...
// Macro for testing egal::math::SoaFloat4 members with x, y, z, w float values.
...
do
{
	\
		SCOPED_TRACE("");                                                         \
		const egal::math::Float4x4 expected(_expected);                            \
...
do
{
	\
		SCOPED_TRACE("");                                                          \
		const egal::math::SoaFloat4 expected(_expected);                            \
...
// Macro for testing egal::math::SoaFloat3 members with x, y, z float values.
...
do
{
	\
		SCOPED_TRACE("");                                                          \
		const egal::math::SoaFloat3 expected(_expected);                            \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.x, _x0, _x1, _x2, _x3);                  \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.y, _y0, _y1, _y2, _y3);                  \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.z, _z0, _z1, _z2, _z3);                  \
} while (void(0), 0)
...
// Macro for testing egal::math::SoaFloat2 members with x, y float values.
#define EXPECT_SOAFLOAT2_EQ(_expected, _x0, _x1, _x2, _x3, _y0, _y1, _y2, _y3) \
do
{
	\
		SCOPED_TRACE("");                                                          \
		const egal::math::SoaFloat2 expected(_expected);                            \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.x, _x0, _x1, _x2, _x3);                  \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.y, _y0, _y1, _y2, _y3);                  \
} while (void(0), 0)
...
// Macro for testing egal::math::SoaQuaternion members with x, y, z, w float
// values.
...
do
{
	\
		SCOPED_TRACE("");                                                         \
		const egal::math::SoaQuaternion expected(_expected);                       \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.x, _x0, _x1, _x2, _x3);                 \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.y, _y0, _y1, _y2, _y3);                 \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.z, _z0, _z1, _z2, _z3);                 \
		IMPL_EXPECT_SIMDFLOAT_EQ(expected.w, _w0, _w1, _w2, _w3);                 \
...
do
{
	\
		SCOPED_TRACE("");                                                          \
		const egal::math::SoaFloat4x4 expected(_expected);                          \
...
// clang-format on
#endif  // MATHS_GTEST_MATH_HELPER_H_
