#ifndef MATHS_QUATERNION_H_
#define MATHS_QUATERNION_H_
...
namespace egal
{
	namespace math
	{
		...
		struct Quaternion
		{
			...
			static INLINE Quaternion FromAxisAngle(const Float4& _axis_angle);
			...
			// Roll.
			static INLINE Quaternion FromEuler(const Float3& _euler);
		...
		INLINE bool operator==(const Quaternion& _a, const Quaternion& _b)
		{
		...
		INLINE Quaternion operator+(const Quaternion& _a, const Quaternion& _b)
		{
		...
		INLINE bool Compare(const math::Quaternion& _a, const math::Quaternion& _b,
			float _tolerance)
		{
		...
		INLINE bool IsNormalized(const Quaternion& _q)
		{
		...
		INLINE Quaternion NormalizeSafe(const Quaternion& _q,
		...
		INLINE Quaternion Quaternion::FromAxisAngle(const Float4& _axis_angle)
		{
		...
		INLINE Float4 ToAxisAngle(const Quaternion& _q)
		{
		...
		INLINE Quaternion Quaternion::FromEuler(const Float3& _euler)
		{
		...
		INLINE Float3 ToEuler(const Quaternion& _q)
		{
		...
		INLINE Quaternion Lerp(const Quaternion& _a, const Quaternion& _b,
			float _f)
		{
		...
		// Returns the linear interpolation of quaternion _a and _b with coefficient _f.
		INLINE Quaternion NLerp(const Quaternion& _a, const Quaternion& _b,
			float _f)
		{
		...
		// coefficient _f.
		INLINE Quaternion SLerp(const Quaternion& _a, const Quaternion& _b,
			float _f)
		{
