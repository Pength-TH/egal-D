...
#ifndef MATHS_SOA_FLOAT4X4_H_
#define MATHS_SOA_FLOAT4X4_H_
...
INLINE egal::math::SoaFloat4 operator*(const egal::math::SoaFloat4x4& _m,
	const egal::math::SoaFloat4& _v)
{
	const egal::math::SoaFloat4 ret =
	{
...
INLINE egal::math::SoaFloat4x4 operator*(const egal::math::SoaFloat4x4& _a,
	const egal::math::SoaFloat4x4& _b)
{
	const egal::math::SoaFloat4x4 ret =
	{
