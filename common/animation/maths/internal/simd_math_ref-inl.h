#ifndef MATHS_INTERNAL_SIMD_MATH_REF_INL_H_
#define MATHS_INTERNAL_SIMD_MATH_REF_INL_H_
...
// clang-format on
		...
		{
			const SimdFloat4 ret =
			{ _a.x * _b.x + _addend.x, _a.y * _b.y + _addend.y,
		...
		{
			const SimdFloat4 ret =
			{ _v.x + _v.y + _v.z + _v.w, _v.y, _v.z, _v.w };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ _a.x * _b.x + _a.y * _b.y, _a.y, _a.z, _a.w };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ _a.x * _b.x + _a.y * _b.y + _a.z * _b.z, _a.y, _a.z,
												_a.w };
			return ret;
		}
		...
		{
			SimdFloat4 ret;
			RCP_EST_NR(_v.x, ret.x);
			RCP_EST_NR(_v.y, ret.y);
			RCP_EST_NR(_v.z, ret.z);
			RCP_EST_NR(_v.w, ret.w);
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::sqrt(_v.x), std::sqrt(_v.y), std::sqrt(_v.z),
												std::sqrt(_v.w) };
			return ret;
		}
		...
		{
			SimdFloat4 ret;
			RSQRT_EST(_v.x, ret.x);
			RSQRT_EST(_v.y, ret.y);
			RSQRT_EST(_v.z, ret.z);
			RSQRT_EST(_v.w, ret.w);
			return ret;
		}
		...
		{
			SimdFloat4 ret;
			RSQRT_EST_NR(_v.x, ret.x);
			RSQRT_EST_NR(_v.y, ret.y);
			RSQRT_EST_NR(_v.z, ret.z);
			RSQRT_EST_NR(_v.w, ret.w);
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::abs(_v.x), std::abs(_v.y), std::abs(_v.z),
												std::abs(_v.w) };
			return ret;
		}
		...
		INLINE SimdFloat4 Length2(_SimdFloat4 _v)
		{
			...
			const SimdFloat4 ret =
			{ std::sqrt(sq_len), _v.y, _v.z, _v.w };
			return ret;
		}
		...
		INLINE SimdFloat4 Normalize2(_SimdFloat4 _v)
		{
			...
			const SimdFloat4 ret =
			{ _v.x * inv_len, _v.y * inv_len, _v.z, _v.w };
			return ret;
		}
		...
		INLINE SimdFloat4 Normalize3(_SimdFloat4 _v)
		{
			...
			const float inv_len = 1.f / std::sqrt(sq_len);
			const SimdFloat4 ret =
			{ _v.x * inv_len, _v.y * inv_len, _v.z * inv_len, _v.w };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ _a.x < _b.x ? _a.x : _b.x, _a.y < _b.y ? _a.y : _b.y,
		...
		{
			const SimdFloat4 ret =
			{ _v.x < 0.f ? _v.x : 0.f, _v.y < 0.f ? _v.y : 0.f,
		...
		{
			const SimdFloat4 min =
			{ _v.x < _b.x ? _v.x : _b.x, _v.y < _b.y ? _v.y : _b.y,
			...
			_SimdFloat4 _false)
		{
			...
			const SimdFI4 i_true =
			{ _true };
			const SimdFI4 i_false =
			{ _false };
			const SimdIF4 ret =
			{
			{i_false.i.x ^ (_b.x & (i_true.i.x ^ i_false.i.x)),
		...
		{
			const SimdFloat4 ret =
			{ std::cos(_v.x), std::cos(_v.y), std::cos(_v.z),
												std::cos(_v.w) };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::acos(_v.x), std::acos(_v.y), std::acos(_v.z),
												std::acos(_v.w) };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::sin(_v.x), std::sin(_v.y), std::sin(_v.z),
												std::sin(_v.w) };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::asin(_v.x), std::asin(_v.y), std::asin(_v.z),
												std::asin(_v.w) };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::tan(_v.x), std::tan(_v.y), std::tan(_v.z),
												std::tan(_v.w) };
			return ret;
		}
		...
		{
			const SimdFloat4 ret =
			{ std::atan(_v.x), std::atan(_v.y), std::atan(_v.z),
												std::atan(_v.w) };
			return ret;
		}
		...
		namespace simd_int4
		{
			...
			{
				const SimdInt4 ret =
				{ static_cast<int>(_f.x), static_cast<int>(_f.y),
		...
		INLINE SimdInt4 MAdd(_SimdInt4 _a, _SimdInt4 _b, _SimdInt4 _addend)
		{
			const SimdInt4 ret =
			{ _a.x * _b.x + _addend.x, _a.y * _b.y + _addend.y,
											  _a.z * _b.z + _addend.z, _a.w * _b.w + _addend.w };
		...
		INLINE SimdInt4 DivX(_SimdInt4 _a, _SimdInt4 _b)
		{
			const SimdInt4 ret =
			{ _a.x / _b.x, _a.y, _a.z, _a.w };
			return ret;
		...
		INLINE SimdInt4 Dot2(_SimdInt4 _a, _SimdInt4 _b)
		{
			const SimdInt4 ret =
			{ _a.x * _b.x + _a.y * _b.y, _a.y, _a.z, _a.w };
			return ret;
		...
		INLINE SimdInt4 Dot3(_SimdInt4 _a, _SimdInt4 _b)
		{
			const SimdInt4 ret =
			{ _a.x * _b.x + _a.y * _b.y + _a.z * _b.z, _a.y, _a.z,
											  _a.w };
		...
		INLINE SimdInt4 Dot4(_SimdInt4 _a, _SimdInt4 _b)
		{
			const SimdInt4 ret =
			{ _a.x * _b.x + _a.y * _b.y + _a.z * _b.z + _a.w * _b.w,
											  _a.y, _a.z, _a.w };
		...
		{
			const SimdInt4 mash =
			{ _v.x >> 31, _v.y >> 31, _v.z >> 31, _v.w >> 31 };
			const SimdInt4 ret =
			{
		...
		{
			const SimdInt4 ret =
			{ _false.x ^ (_b.x & (_true.x ^ _false.x)),
		...
		{
			const SimdInt4 ret =
			{ _v.x << _bits, _v.y << _bits, _v.z << _bits,
											  _v.w << _bits };
			return ret;
		}
		...
		INLINE Float4x4 Scale(const Float4x4& _m, _SimdFloat4 _v)
		{
			const Float4x4 ret =
			{
			{{_m.cols[0].x * _v.x, _m.cols[0].y * _v.x,
		...
		INLINE Float4x4 ColumnMultiply(const Float4x4& _m, _SimdFloat4 _v)
		{
			const Float4x4 ret =
			{
			{{_m.cols[0].x * _v.x, _m.cols[0].y * _v.y,
		...
		INLINE Float4x4 Float4x4::FromQuaternion(_SimdFloat4 _v)
		{
		...
		{
			const egal::math::SimdFloat4 ret =
			{ _m.cols[0].x * _v.x + _m.cols[1].x * _v.y +
															   _m.cols[2].x * _v.z + _m.cols[3].x,
														   _m.cols[0].y * _v.x + _m.cols[1].y * _v.y +
															   _m.cols[2].y * _v.z + _m.cols[3].y,
...
namespace egal
{
	namespace math
	{
		...
		INLINE float HalfToFloat(uint16_t _h)
		{
			...
			{ (adjust.f >= infnan.f ? (adjust.u | 255 << 23) : adjust.u) |
									(sign << 16) };
			return result.f;
		}
		...
		{
			const egal::math::SimdInt4 ret =
			{ FloatToHalf(_f.x), FloatToHalf(_f.y),
...
#undef RCP_EST
#undef RSQRT_EST
#endif  // MATHS_INTERNAL_SIMD_MATH_REF_INL_H_
