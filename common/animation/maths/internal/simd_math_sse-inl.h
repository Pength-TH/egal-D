#ifndef MATHS_INTERNAL_SIMD_MATH_SSE_INL_H_
#define MATHS_INTERNAL_SIMD_MATH_SSE_INL_H_
...
#define SSE_SPLAT_F(_v, _i) \
  _mm_shuffle_ps(_v, _v, _MM_SHUFFLE(_i, _i, _i, _i))

// _v.x + _v.y, _v.y, _v.z, _v.w
#define SSE_HADD2_F(_v) _mm_add_ss(_v, SSE_SPLAT_F(_v, 1))

// _v.x + _v.y + _v.z, _v.y, _v.z, _v.w
#define SSE_HADD3_F(_v) \
  _mm_add_ss(_mm_add_ss(_v, _mm_unpackhi_ps(_v, _v)), SSE_SPLAT_F(_v, 1))

// _v.x + _v.y + _v.z, ?, ?, ?
#define SSE_HADD4_F(_v, _r)                                        \
do {                                                               \
    const __m128 haddxyzw = _mm_add_ps(_v, _mm_movehl_ps(_v, _v)); \
    _r = _mm_add_ss(haddxyzw, SSE_SPLAT_F(haddxyzw, 1));           \
} while (void(0), 0)

// dot2, ?, ?, ?
#define SSE_DOT2_F(_a, _b, _r)                   \
do {                                             \
    const __m128 ab = _mm_mul_ps(_a, _b);        \
    _r = _mm_add_ss(ab, SSE_SPLAT_F(ab, 1));     \
} while (void(0), 0)

// dot3, ?, ?, ?
#define SSE_DOT3_F(_a, _b, _r)			  \
do {                                      \
    const __m128 ab = _mm_mul_ps(_a, _b); \
    _r = SSE_HADD3_F(ab);				  \
} while (void(0), 0)
...
// dot4, ?, ?, ?
#define SSE_DOT4_F(_a, _b, _r)			  \
do {                                      \
    const __m128 ab = _mm_mul_ps(_a, _b); \
    SSE_HADD4_F(ab, _r);				  \
} while (void(0), 0)

#define SSE_SELECT_F(_b, _true, _false) \
  _mm_xor_ps(_false,                        \
...
INLINE SimdFloat4 zero()
	{
		return _mm_setzero_ps();
	}

	INLINE SimdFloat4 one()
	{
	...
	INLINE SimdFloat4 Load(float _x, float _y, float _z, float _w)
	{
		return _mm_set_ps(_w, _z, _y, _x);
	}

	INLINE SimdFloat4 LoadX(float _x)
	{
		return _mm_set_ss(_x);
	}

	INLINE SimdFloat4 Load1(float _x)
	{
		return _mm_set_ps1(_x);
	}

	INLINE SimdFloat4 LoadPtr(const float* _f)
	{
		assert(!(reinterpret_cast<uintptr_t>(_f) & 0xf) && "Invalid alignment");
		return _mm_load_ps(_f);
	}

	INLINE SimdFloat4 LoadPtrU(const float* _f)
	{
		assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
		return _mm_loadu_ps(_f);
	}

	INLINE SimdFloat4 LoadXPtrU(const float* _f)
	{
		assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
		return _mm_load_ss(_f);
	}

	INLINE SimdFloat4 Load1PtrU(const float* _f)
	{
		assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
		return _mm_load_ps1(_f);
	}

	INLINE SimdFloat4 Load2PtrU(const float* _f)
	{
		assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
		return _mm_unpacklo_ps(_mm_load_ss(_f + 0), _mm_load_ss(_f + 1));
	}

	INLINE SimdFloat4 Load3PtrU(const float* _f)
	{
		assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
	...
	INLINE SimdFloat4 FromInt(_SimdInt4 _i)
	{
		return _mm_cvtepi32_ps(_i);
	}
		}  // egal::math::simd_float4

		INLINE float GetX(_SimdFloat4 _v)
		{
			return _mm_cvtss_f32(_v);
		}

		INLINE float GetY(_SimdFloat4 _v)
		{
			return _mm_cvtss_f32(SSE_SPLAT_F(_v, 1));
		}

		INLINE float GetZ(_SimdFloat4 _v)
		{
			return _mm_cvtss_f32(_mm_movehl_ps(_v, _v));
		}

		INLINE float GetW(_SimdFloat4 _v)
		{
			return _mm_cvtss_f32(SSE_SPLAT_F(_v, 3));
		}

		INLINE SimdFloat4 SetX(_SimdFloat4 _v, float _f)
		{
			return _mm_move_ss(_v, _mm_set_ss(_f));
		}

		INLINE SimdFloat4 SetY(_SimdFloat4 _v, float _f)
		{
		...
		INLINE SimdFloat4 SetZ(_SimdFloat4 _v, float _f)
		{
		...
		INLINE SimdFloat4 SetW(_SimdFloat4 _v, float _f)
		{
		...
		INLINE SimdFloat4 SetI(_SimdFloat4 _v, int _ith, float _f)
		{
		...
		INLINE void StorePtr(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0xf) && "Invalid alignment");
			_mm_store_ps(_f, _v);
		}

		INLINE void Store1Ptr(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0xf) && "Invalid alignment");
			_mm_store_ss(_f, _v);
		}

		INLINE void Store2Ptr(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0xf) && "Invalid alignment");
			_mm_storel_pi(reinterpret_cast<__m64*>(_f), _v);
		}

		INLINE void Store3Ptr(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0xf) && "Invalid alignment");
			_mm_storel_pi(reinterpret_cast<__m64*>(_f), _v);
		...
		INLINE void StorePtrU(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
			_mm_storeu_ps(_f, _v);
		}

		INLINE void Store1PtrU(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
			_mm_store_ss(_f, _v);
		}

		INLINE void Store2PtrU(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
			_mm_store_ss(_f + 0, _v);
			_mm_store_ss(_f + 1, SSE_SPLAT_F(_v, 1));
		}

		INLINE void Store3PtrU(_SimdFloat4 _v, float* _f)
		{
			assert(!(reinterpret_cast<uintptr_t>(_f) & 0x3) && "Invalid alignment");
			_mm_store_ss(_f + 0, _v);
			_mm_store_ss(_f + 1, SSE_SPLAT_F(_v, 1));
		...
		INLINE SimdFloat4 SplatX(_SimdFloat4 _v)
		{
			return SSE_SPLAT_F(_v, 0);
		}

		INLINE SimdFloat4 SplatY(_SimdFloat4 _v)
		{
			return SSE_SPLAT_F(_v, 1);
		}

		INLINE SimdFloat4 SplatZ(_SimdFloat4 _v)
		{
			return SSE_SPLAT_F(_v, 2);
		}

		INLINE SimdFloat4 SplatW(_SimdFloat4 _v)
		{
			return SSE_SPLAT_F(_v, 3);
		}

		INLINE void Transpose4x1(const SimdFloat4 _in[4], SimdFloat4 _out[1])
		{
		...
		INLINE void Transpose1x4(const SimdFloat4 _in[1], SimdFloat4 _out[4])
		{
			const __m128 zwzw = _mm_movehl_ps(_in[0], _in[0]);
			const __m128 yyyy = SSE_SPLAT_F(_in[0], 1);
			const __m128 wwww = SSE_SPLAT_F(_in[0], 3);
		...
		INLINE void Transpose4x2(const SimdFloat4 _in[4], SimdFloat4 _out[2])
		{
		...
		INLINE void Transpose2x4(const SimdFloat4 _in[2], SimdFloat4 _out[4])
		{
		...
		INLINE void Transpose4x3(const SimdFloat4 _in[4], SimdFloat4 _out[3])
		{
			const __m128 tmp0 = _mm_unpacklo_ps(_in[0], _in[2]);
			const __m128 tmp1 = _mm_unpacklo_ps(_in[1], _in[3]);
		...
		INLINE void Transpose3x4(const SimdFloat4 _in[3], SimdFloat4 _out[4])
		{
			const __m128 zero = _mm_setzero_ps();
		...
		INLINE void Transpose4x4(const SimdFloat4 _in[4], SimdFloat4 _out[4])
		{
			const __m128 tmp0 = _mm_unpacklo_ps(_in[0], _in[2]);
			const __m128 tmp1 = _mm_unpacklo_ps(_in[1], _in[3]);
			const __m128 tmp2 = _mm_unpackhi_ps(_in[0], _in[2]);
		...
		INLINE void Transpose16x16(const SimdFloat4 _in[16], SimdFloat4 _out[16])
		{
			const __m128 tmp0 = _mm_unpacklo_ps(_in[0], _in[2]);
			const __m128 tmp1 = _mm_unpacklo_ps(_in[1], _in[3]);
			const __m128 tmp2 = _mm_unpackhi_ps(_in[0], _in[2]);
		...
		INLINE SimdFloat4 MAdd(_SimdFloat4 _a, _SimdFloat4 _b,
			_SimdFloat4 _addend)
		{
		...
		INLINE SimdFloat4 HAdd2(_SimdFloat4 _v)
		{
			return SSE_HADD2_F(_v);
		}

		INLINE SimdFloat4 HAdd3(_SimdFloat4 _v)
		{
			return SSE_HADD3_F(_v);
		}

		INLINE SimdFloat4 HAdd4(_SimdFloat4 _v)
		{
			__m128 hadd4;
			SSE_HADD4_F(_v, hadd4);
			return _mm_move_ss(_v, hadd4);
		}

		INLINE SimdFloat4 Dot2(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			__m128 dot2;
			SSE_DOT2_F(_a, _b, dot2);
			return _mm_move_ss(_a, dot2);
		}

		INLINE SimdFloat4 Dot3(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			__m128 dot3;
			SSE_DOT3_F(_a, _b, dot3);
			return _mm_move_ss(_a, dot3);
		}

		INLINE SimdFloat4 Dot4(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			__m128 dot4;
			SSE_DOT4_F(_a, _b, dot4);
			return _mm_move_ss(_a, dot4);
		}

		INLINE SimdFloat4 Cross3(_SimdFloat4 _a, _SimdFloat4 _b)
		{
		...
		INLINE SimdFloat4 RcpEst(_SimdFloat4 _v)
		{
			return _mm_rcp_ps(_v);
		}

		INLINE SimdFloat4 RcpEstNR(_SimdFloat4 _v)
		{
		...
		INLINE SimdFloat4 RcpEstX(_SimdFloat4 _v)
		{
			return _mm_rcp_ss(_v);
		}

		INLINE SimdFloat4 Sqrt(_SimdFloat4 _v)
		{
			return _mm_sqrt_ps(_v);
		}

		INLINE SimdFloat4 SqrtX(_SimdFloat4 _v)
		{
			return _mm_sqrt_ss(_v);
		}

		INLINE SimdFloat4 RSqrtEst(_SimdFloat4 _v)
		{
			return _mm_rsqrt_ps(_v);
		}

		INLINE SimdFloat4 RSqrtEstNR(_SimdFloat4 _v)
		{
		...
		INLINE SimdFloat4 RSqrtEstX(_SimdFloat4 _v)
		{
			return _mm_rsqrt_ss(_v);
		}

		INLINE SimdFloat4 Abs(_SimdFloat4 _v)
		{
			return _mm_and_ps(_mm_castsi128_ps(simd_int4::mask_not_sign()), _v);
		}

		INLINE SimdInt4 Sign(_SimdFloat4 _v)
		{
			return _mm_slli_epi32(_mm_srli_epi32(_mm_castps_si128(_v), 31), 31);
		}

		INLINE SimdFloat4 Length2(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT2_F(_v, _v, sq_len);
			return _mm_move_ss(_v, _mm_sqrt_ss(sq_len));
		}

		INLINE SimdFloat4 Length3(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT3_F(_v, _v, sq_len);
			return _mm_move_ss(_v, _mm_sqrt_ss(sq_len));
		}

		INLINE SimdFloat4 Length4(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT4_F(_v, _v, sq_len);
			return _mm_move_ss(_v, _mm_sqrt_ss(sq_len));
		}

		INLINE SimdFloat4 Length2Sqr(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT2_F(_v, _v, sq_len);
		...
		INLINE SimdFloat4 Length3Sqr(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT3_F(_v, _v, sq_len);
			return _mm_move_ss(_v, sq_len);
		...
		INLINE SimdFloat4 Length4Sqr(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT4_F(_v, _v, sq_len);
			return _mm_move_ss(_v, sq_len);
		...
		INLINE SimdFloat4 Normalize4(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT4_F(_v, _v, sq_len);
			assert(_mm_cvtss_f32(sq_len) != 0.f && "_v is not normalizable");
		...
		INLINE SimdFloat4 NormalizeEst2(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT2_F(_v, _v, sq_len);
			assert(_mm_cvtss_f32(sq_len) != 0.f && "_v is not normalizable");
		...
		INLINE SimdFloat4 NormalizeEst3(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT3_F(_v, _v, sq_len);
			assert(_mm_cvtss_f32(sq_len) != 0.f && "_v is not normalizable");
		...
		INLINE SimdFloat4 NormalizeEst4(_SimdFloat4 _v)
		{
			__m128 sq_len;
			SSE_DOT4_F(_v, _v, sq_len);
			assert(_mm_cvtss_f32(sq_len) != 0.f && "_v is not normalizable");
		...
		INLINE SimdInt4 IsNormalized2(_SimdFloat4 _v)
		{
			const __m128 max = _mm_set_ss(1.f + kNormalizationToleranceSq);
			const __m128 min = _mm_set_ss(1.f - kNormalizationToleranceSq);
			__m128 dot;
			SSE_DOT2_F(_v, _v, dot);
			__m128 dotx000 = _mm_move_ss(_mm_setzero_ps(), dot);
			return _mm_castps_si128(
				_mm_and_ps(_mm_cmplt_ss(dotx000, max), _mm_cmpgt_ss(dotx000, min)));
		}

		INLINE SimdInt4 IsNormalized3(_SimdFloat4 _v)
		{
			const __m128 max = _mm_set_ss(1.f + kNormalizationToleranceSq);
			const __m128 min = _mm_set_ss(1.f - kNormalizationToleranceSq);
			__m128 dot;
			SSE_DOT3_F(_v, _v, dot);
			__m128 dotx000 = _mm_move_ss(_mm_setzero_ps(), dot);
			return _mm_castps_si128(
				_mm_and_ps(_mm_cmplt_ss(dotx000, max), _mm_cmpgt_ss(dotx000, min)));
		}

		INLINE SimdInt4 IsNormalized4(_SimdFloat4 _v)
		{
			const __m128 max = _mm_set_ss(1.f + kNormalizationToleranceSq);
			const __m128 min = _mm_set_ss(1.f - kNormalizationToleranceSq);
			__m128 dot;
			SSE_DOT4_F(_v, _v, dot);
			__m128 dotx000 = _mm_move_ss(_mm_setzero_ps(), dot);
			return _mm_castps_si128(
				_mm_and_ps(_mm_cmplt_ss(dotx000, max), _mm_cmpgt_ss(dotx000, min)));
		}

		INLINE SimdInt4 IsNormalizedEst2(_SimdFloat4 _v)
		{
		...
		INLINE SimdInt4 IsNormalizedEst3(_SimdFloat4 _v)
		{
			const __m128 max = _mm_set_ss(1.f + kNormalizationToleranceEstSq);
			const __m128 min = _mm_set_ss(1.f - kNormalizationToleranceEstSq);
			__m128 dot;
		...
		INLINE SimdInt4 IsNormalizedEst4(_SimdFloat4 _v)
		{
			const __m128 max = _mm_set_ss(1.f + kNormalizationToleranceEstSq);
			const __m128 min = _mm_set_ss(1.f - kNormalizationToleranceEstSq);
			__m128 dot;
		...
		INLINE SimdFloat4 NormalizeSafe2(_SimdFloat4 _v, _SimdFloat4 _safe)
		{
			__m128 sq_len;
			SSE_DOT2_F(_v, _v, sq_len);
			const __m128 inv_len = _mm_div_ss(simd_float4::one(), _mm_sqrt_ss(sq_len));
			...
			const __m128i cond = _mm_castps_si128(
				_mm_cmple_ps(SSE_SPLAT_F(sq_len, 0), _mm_setzero_ps()));
			const __m128 cfalse = _mm_movelh_ps(norm, _mm_movehl_ps(_v, _v));
			return SSE_SELECT_F(cond, _safe, cfalse);
		}

		INLINE SimdFloat4 NormalizeSafe3(_SimdFloat4 _v, _SimdFloat4 _safe)
		{
			__m128 sq_len;
			SSE_DOT3_F(_v, _v, sq_len);
			const __m128 inv_len = _mm_div_ss(simd_float4::one(), _mm_sqrt_ss(sq_len));
		...
		INLINE SimdFloat4 NormalizeSafe4(_SimdFloat4 _v, _SimdFloat4 _safe)
		{
			__m128 sq_len;
			SSE_DOT4_F(_v, _v, sq_len);
			const __m128 inv_len = _mm_div_ss(simd_float4::one(), _mm_sqrt_ss(sq_len));
		...
		INLINE SimdFloat4 NormalizeSafeEst2(_SimdFloat4 _v, _SimdFloat4 _safe)
		{
			__m128 sq_len;
			SSE_DOT2_F(_v, _v, sq_len);
			const __m128 inv_len = _mm_rsqrt_ss(sq_len);
		...
		INLINE SimdFloat4 NormalizeSafeEst3(_SimdFloat4 _v, _SimdFloat4 _safe)
		{
			__m128 sq_len;
			SSE_DOT3_F(_v, _v, sq_len);
			const __m128 inv_len = _mm_rsqrt_ss(sq_len);
		...
		INLINE SimdFloat4 NormalizeSafeEst4(_SimdFloat4 _v, _SimdFloat4 _safe)
		{
			__m128 sq_len;
			SSE_DOT4_F(_v, _v, sq_len);
			const __m128 inv_len = _mm_rsqrt_ss(sq_len);
		...
		INLINE SimdFloat4 Lerp(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _alpha)
		{
			return _mm_add_ps(_mm_mul_ps(_alpha, _mm_sub_ps(_b, _a)), _a);
		}

		INLINE SimdFloat4 Min(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_min_ps(_a, _b);
		}

		INLINE SimdFloat4 Max(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_max_ps(_a, _b);
		}

		INLINE SimdFloat4 Min0(_SimdFloat4 _v)
		{
			return _mm_min_ps(_mm_setzero_ps(), _v);
		}

		INLINE SimdFloat4 Max0(_SimdFloat4 _v)
		{
			return _mm_max_ps(_mm_setzero_ps(), _v);
		}

		INLINE SimdFloat4 Clamp(_SimdFloat4 _a, _SimdFloat4 _v, _SimdFloat4 _b)
		{
			return _mm_max_ps(_a, _mm_min_ps(_v, _b));
		}

		INLINE SimdFloat4 Select(_SimdInt4 _b, _SimdFloat4 _true,
			_SimdFloat4 _false)
		{
			return SSE_SELECT_F(_b, _true, _false);
		}

		INLINE SimdInt4 CmpEq(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_castps_si128(_mm_cmpeq_ps(_a, _b));
		}

		INLINE SimdInt4 CmpNe(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_castps_si128(_mm_cmpneq_ps(_a, _b));
		}

		INLINE SimdInt4 CmpLt(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_castps_si128(_mm_cmplt_ps(_a, _b));
		}

		INLINE SimdInt4 CmpLe(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_castps_si128(_mm_cmple_ps(_a, _b));
		}

		INLINE SimdInt4 CmpGt(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_castps_si128(_mm_cmpgt_ps(_a, _b));
		}

		INLINE SimdInt4 CmpGe(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_castps_si128(_mm_cmpge_ps(_a, _b));
		}

		INLINE SimdFloat4 And(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_and_ps(_a, _b);
		}

		INLINE SimdFloat4 Or(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_or_ps(_a, _b);
		}

		INLINE SimdFloat4 Xor(_SimdFloat4 _a, _SimdFloat4 _b)
		{
			return _mm_xor_ps(_a, _b);
		}

		INLINE SimdFloat4 And(_SimdFloat4 _a, _SimdInt4 _b)
		{
			return _mm_and_ps(_a, _mm_castsi128_ps(_b));
		}

		INLINE SimdFloat4 Or(_SimdFloat4 _a, _SimdInt4 _b)
		{
			return _mm_or_ps(_a, _mm_castsi128_ps(_b));
		}

		INLINE SimdFloat4 Xor(_SimdFloat4 _a, _SimdInt4 _b)
		{
			return _mm_xor_ps(_a, _mm_castsi128_ps(_b));
		}

		INLINE SimdFloat4 Cos(_SimdFloat4 _v)
		{
			return _mm_set_ps(std::cos(GetW(_v)), std::cos(GetZ(_v)), std::cos(GetY(_v)),
				std::cos(GetX(_v)));
		}

		INLINE SimdFloat4 CosX(_SimdFloat4 _v)
		{
			return _mm_set_ps(GetW(_v), GetZ(_v), GetY(_v), std::cos(GetX(_v)));
		}

		INLINE SimdFloat4 ACos(_SimdFloat4 _v)
		{
			return _mm_set_ps(std::acos(GetW(_v)), std::acos(GetZ(_v)),
				std::acos(GetY(_v)), std::acos(GetX(_v)));
		}

		INLINE SimdFloat4 ACosX(_SimdFloat4 _v)
		{
			return _mm_set_ps(GetW(_v), GetZ(_v), GetY(_v), std::acos(GetX(_v)));
		}

		INLINE SimdFloat4 Sin(_SimdFloat4 _v)
		{
			return _mm_set_ps(std::sin(GetW(_v)), std::sin(GetZ(_v)), std::sin(GetY(_v)),
				std::sin(GetX(_v)));
		}

		INLINE SimdFloat4 SinX(_SimdFloat4 _v)
		{
			return _mm_set_ps(GetW(_v), GetZ(_v), GetY(_v), std::sin(GetX(_v)));
		}

		INLINE SimdFloat4 ASin(_SimdFloat4 _v)
		{
			return _mm_set_ps(std::asin(GetW(_v)), std::asin(GetZ(_v)),
				std::asin(GetY(_v)), std::asin(GetX(_v)));
		}

		INLINE SimdFloat4 ASinX(_SimdFloat4 _v)
		{
			return _mm_set_ps(GetW(_v), GetZ(_v), GetY(_v), std::asin(GetX(_v)));
		}

		INLINE SimdFloat4 Tan(_SimdFloat4 _v)
		{
			return _mm_set_ps(std::tan(GetW(_v)), std::tan(GetZ(_v)), std::tan(GetY(_v)),
				std::tan(GetX(_v)));
		}

		INLINE SimdFloat4 TanX(_SimdFloat4 _v)
		{
			return _mm_set_ps(GetW(_v), GetZ(_v), GetY(_v), std::tan(GetX(_v)));
		}

		INLINE SimdFloat4 ATan(_SimdFloat4 _v)
		{
			return _mm_set_ps(std::atan(GetW(_v)), std::atan(GetZ(_v)),
				std::atan(GetY(_v)), std::atan(GetX(_v)));
		}

		INLINE SimdFloat4 ATanX(_SimdFloat4 _v)
		{
		...
		namespace simd_int4
		{
			...
			INLINE SimdInt4 all_true()
			{
				return _mm_cmpeq_epi32(_mm_setzero_si128(), _mm_setzero_si128());
			}

			INLINE SimdInt4 all_false()
			{
				return _mm_setzero_si128();
			}

			INLINE SimdInt4 mask_sign()
			{
				const __m128i ffff =
			...
			INLINE SimdInt4 mask_ffff()
			{
				return _mm_cmpeq_epi32(_mm_setzero_si128(), _mm_setzero_si128());
			}
			INLINE SimdInt4 mask_0000()
			{
				return _mm_setzero_si128();
			}

			INLINE SimdInt4 mask_fff0()
			{
				const __m128i zero = _mm_setzero_si128();
				const __m128i ffff = _mm_cmpeq_epi32(zero, zero);
			...
			INLINE SimdInt4 Load2Ptr(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0xf) && "Invalid alignment");
				return _mm_loadl_epi64(reinterpret_cast<const __m128i*>(_i));
			}

			INLINE SimdInt4 Load3Ptr(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0xf) && "Invalid alignment");
				return _mm_set_epi32(0, _i[2], _i[1], _i[0]);
			}

			INLINE SimdInt4 LoadPtrU(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
				return _mm_loadu_si128(reinterpret_cast<const __m128i*>(_i));
			}

			INLINE SimdInt4 LoadXPtrU(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
				return _mm_cvtsi32_si128(*_i);
			}

			INLINE SimdInt4 Load1PtrU(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
				return _mm_set1_epi32(*_i);
			}

			INLINE SimdInt4 Load2PtrU(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
				return _mm_set_epi32(0, 0, _i[1], _i[0]);
			}

			INLINE SimdInt4 Load3PtrU(const int* _i)
			{
				assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
				return _mm_set_epi32(0, _i[2], _i[1], _i[0]);
			}

			INLINE SimdInt4 FromFloatRound(_SimdFloat4 _f)
			{
				return _mm_cvtps_epi32(_f);
			}

			INLINE SimdInt4 FromFloatTrunc(_SimdFloat4 _f)
			{
				return _mm_cvttps_epi32(_f);
			}
		}  // namespace simd_int4

		INLINE int GetX(_SimdInt4 _v)
		{
			return _mm_cvtsi128_si32(_v);
		}

		INLINE int GetY(_SimdInt4 _v)
		{
			return _mm_cvtsi128_si32(SSE_SPLAT_I(_v, 1));
		}

		INLINE int GetZ(_SimdInt4 _v)
		{
			return _mm_cvtsi128_si32(_mm_unpackhi_epi32(_v, _v));
		}

		INLINE int GetW(_SimdInt4 _v)
		{
			return _mm_cvtsi128_si32(SSE_SPLAT_I(_v, 3));
		}

		INLINE SimdInt4 SetX(_SimdInt4 _v, int _i)
		{
			return _mm_castps_si128(
				_mm_move_ss(_mm_castsi128_ps(_v), _mm_castsi128_ps(_mm_set1_epi32(_i))));
		}

		INLINE SimdInt4 SetY(_SimdInt4 _v, int _i)
		{
		...
		INLINE SimdInt4 SetZ(_SimdInt4 _v, int _i)
		{
			const __m128 i = _mm_castsi128_ps(_mm_set1_epi32(_i));
			const __m128 v = _mm_castsi128_ps(_v);
		...
		INLINE SimdInt4 SetW(_SimdInt4 _v, int _i)
		{
			const __m128 i = _mm_castsi128_ps(_mm_set1_epi32(_i));
			const __m128 v = _mm_castsi128_ps(_v);
		...
		INLINE SimdInt4 SetI(_SimdInt4 _v, int _ith, int _i)
		{
			assert(_ith >= 0 && _ith <= 3 && "Invalid index ranges");
			union
			{
		...
		INLINE void StorePtr(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0xf) && "Invalid alignment");
			_mm_store_si128(reinterpret_cast<__m128i*>(_i), _v);
		}

		INLINE void Store1Ptr(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0xf) && "Invalid alignment");
			*_i = _mm_cvtsi128_si32(_v);
		}

		INLINE void Store2Ptr(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0xf) && "Invalid alignment");
		...
		INLINE void Store3Ptr(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0xf) && "Invalid alignment");
			_i[0] = _mm_cvtsi128_si32(_v);
			_i[1] = _mm_cvtsi128_si32(SSE_SPLAT_I(_v, 1));
		...
		INLINE void StorePtrU(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
			_mm_storeu_si128(reinterpret_cast<__m128i*>(_i), _v);
		}

		INLINE void Store1PtrU(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
			*_i = _mm_cvtsi128_si32(_v);
		}

		INLINE void Store2PtrU(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
			_i[0] = _mm_cvtsi128_si32(_v);
			_i[1] = _mm_cvtsi128_si32(SSE_SPLAT_I(_v, 1));
		...
		INLINE void Store3PtrU(_SimdInt4 _v, int* _i)
		{
			assert(!(uintptr_t(_i) & 0x3) && "Invalid alignment");
			_i[0] = _mm_cvtsi128_si32(_v);
			_i[1] = _mm_cvtsi128_si32(SSE_SPLAT_I(_v, 1));
		...
		INLINE SimdInt4 SplatX(_SimdInt4 _a)
		{
			return SSE_SPLAT_I(_a, 0);
		}

		INLINE SimdInt4 SplatY(_SimdInt4 _a)
		{
			return SSE_SPLAT_I(_a, 1);
		}

		INLINE SimdInt4 SplatZ(_SimdInt4 _a)
		{
			return SSE_SPLAT_I(_a, 2);
		}

		INLINE SimdInt4 SplatW(_SimdInt4 _a)
		{
			return SSE_SPLAT_I(_a, 3);
		}

		INLINE int MoveMask(_SimdInt4 _v)
		{
			return _mm_movemask_ps(_mm_castsi128_ps(_v));
		}

		INLINE bool AreAllTrue(_SimdInt4 _v)
		{
			return _mm_movemask_ps(_mm_castsi128_ps(_v)) == 0xf;
		}

		INLINE bool AreAllTrue3(_SimdInt4 _v)
		{
			return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x7) == 0x7;
		}

		INLINE bool AreAllTrue2(_SimdInt4 _v)
		{
			return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x3) == 0x3;
		}

		INLINE bool AreAllTrue1(_SimdInt4 _v)
		{
			return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x1) == 0x1;
		}

		INLINE bool AreAllFalse(_SimdInt4 _v)
		{
			return _mm_movemask_ps(_mm_castsi128_ps(_v)) == 0;
		}

		INLINE bool AreAllFalse3(_SimdInt4 _v)
		{
			return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x7) == 0;
		}

		INLINE bool AreAllFalse2(_SimdInt4 _v)
		{
			return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x3) == 0;
		}

		INLINE bool AreAllFalse1(_SimdInt4 _v)
		{
			return (_mm_movemask_ps(_mm_castsi128_ps(_v)) & 0x1) == 0;
		}

		INLINE SimdInt4 HAdd2(_SimdInt4 _v)
		{
		...
		INLINE SimdInt4 HAdd3(_SimdInt4 _v)
		{
		...
		INLINE SimdInt4 HAdd4(_SimdInt4 _v)
		{
			const __m128 v = _mm_castsi128_ps(_v);
		...
		INLINE SimdInt4 Abs(_SimdInt4 _v)
		{
			const __m128i zero = _mm_setzero_si128();
		...
		INLINE SimdInt4 Sign(_SimdInt4 _v)
		{
			return _mm_slli_epi32(_mm_srli_epi32(_v, 31), 31);
		}

		INLINE SimdInt4 Min(_SimdInt4 _a, _SimdInt4 _b)
		{
			// SSE4 _mm_min_epi32
			return SSE_SELECT_I(_mm_cmplt_epi32(_a, _b), _a, _b);
		}

		INLINE SimdInt4 Max(_SimdInt4 _a, _SimdInt4 _b)
		{
			// SSE4 _mm_max_epi32
			return SSE_SELECT_I(_mm_cmpgt_epi32(_a, _b), _a, _b);
		}

		INLINE SimdInt4 Min0(_SimdInt4 _v)
		{
			// SSE4 _mm_min_epi32
			const __m128i zero = _mm_setzero_si128();
		...
		INLINE SimdInt4 Max0(_SimdInt4 _v)
		{
			// SSE4 _mm_max_epi32
			const __m128i zero = _mm_setzero_si128();
		...
		INLINE SimdInt4 Clamp(_SimdInt4 _a, _SimdInt4 _v, _SimdInt4 _b)
		{
		...
		INLINE SimdInt4 Select(_SimdInt4 _b, _SimdInt4 _true, _SimdInt4 _false)
		{
			return SSE_SELECT_I(_b, _true, _false);
		}

		INLINE SimdInt4 And(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_and_si128(_a, _b);
		}

		INLINE SimdInt4 Or(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_or_si128(_a, _b);
		}

		INLINE SimdInt4 Xor(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_xor_si128(_a, _b);
		}

		INLINE SimdInt4 Not(_SimdInt4 _v)
		{
			return _mm_andnot_si128(
				_v, _mm_cmpeq_epi32(_mm_setzero_si128(), _mm_setzero_si128()));
		}

		INLINE SimdInt4 ShiftL(_SimdInt4 _v, int _bits)
		{
			return _mm_slli_epi32(_v, _bits);
		}

		INLINE SimdInt4 ShiftR(_SimdInt4 _v, int _bits)
		{
			return _mm_srai_epi32(_v, _bits);
		}

		INLINE SimdInt4 ShiftRu(_SimdInt4 _v, int _bits)
		{
			return _mm_srli_epi32(_v, _bits);
		}

		INLINE SimdInt4 CmpEq(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_cmpeq_epi32(_a, _b);
		}

		INLINE SimdInt4 CmpNe(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_castps_si128(
				_mm_cmpneq_ps(_mm_castsi128_ps(_a), _mm_castsi128_ps(_b)));
		}

		INLINE SimdInt4 CmpLt(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_cmplt_epi32(_a, _b);
		}

		INLINE SimdInt4 CmpLe(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_andnot_si128(
		...
		INLINE SimdInt4 CmpGt(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_cmpgt_epi32(_a, _b);
		}

		INLINE SimdInt4 CmpGe(_SimdInt4 _a, _SimdInt4 _b)
		{
			return _mm_andnot_si128(
		...
		INLINE Float4x4 Transpose(const Float4x4& _m)
		{
		...
		INLINE Float4x4 Invert(const Float4x4& _m)
		{
			...
			const Float4x4 ret =
			{
			{_mm_mul_ps(det, minor0), _mm_mul_ps(det, minor1),
		...
		Float4x4 Float4x4::Translation(_SimdFloat4 _v)
		{
			...
			const Float4x4 ret =
			{
							{_mm_castsi128_ps(x), _mm_castsi128_ps(_mm_slli_si128(x, 4)),
							 _mm_castsi128_ps(_mm_slli_si128(x, 8)),
							 SSE_SELECT_F(mask000f, _mm_castsi128_ps(one), _v)} };
			return ret;
		}  // math
		...
		INLINE Float4x4 Translate(const Float4x4& _m, _SimdFloat4 _v)
		{
			const __m128 vxxxx = SSE_SPLAT_F(_v, 0);
			const __m128 vyyyy = SSE_SPLAT_F(_v, 1);
			const __m128 m0 = _mm_mul_ps(_m.cols[0], vxxxx);
			const __m128 m1 = _mm_mul_ps(_m.cols[1], vyyyy);
			const __m128 vzzzz = SSE_SPLAT_F(_v, 2);
			...
			const Float4x4 ret =
			{
			{_m.cols[0], _m.cols[1], _m.cols[2], col3} };
			return ret;
		}

		INLINE Float4x4 Scale(const Float4x4& _m, _SimdFloat4 _v)
		{
			const Float4x4 ret =
			{
			{_mm_mul_ps(_m.cols[0], SSE_SPLAT_F(_v, 0)),
											   _mm_mul_ps(_m.cols[1], SSE_SPLAT_F(_v, 1)),
											   _mm_mul_ps(_m.cols[2], SSE_SPLAT_F(_v, 2)),
											   _m.cols[3]} };
			return ret;
		}

		INLINE Float4x4 ColumnMultiply(const Float4x4& _m, _SimdFloat4 _v)
		{
			const Float4x4 ret =
			{
			{_mm_mul_ps(_m.cols[0], _v), _mm_mul_ps(_m.cols[1], _v),
		...
		INLINE SimdInt4 IsOrthogonal(const Float4x4& _m)
		{
			const __m128 max = _mm_set_ss(1.f + kNormalizationToleranceSq);
			const __m128 min = _mm_set_ss(1.f - kNormalizationToleranceSq);
			const __m128 zero = _mm_setzero_ps();
		...
		INLINE SimdFloat4 ToQuaternion(const Float4x4& _m)
		{
			...
			const __m128 xx_yy = SSE_SELECT_F(mask_0f00, _m.cols[1], _m.cols[0]);
			const __m128 xx_yy_0010 =
				_mm_shuffle_ps(xx_yy, xx_yy, _MM_SHUFFLE(0, 0, 1, 0));
			const __m128 xx_yy_zz_xx =
				SSE_SELECT_F(mask_00f0, _m.cols[2], xx_yy_0010);
			...
			const __m128 radicand =
				_mm_add_ps(SSE_SELECT_F(mask_000f, diag_sum, diag_diff), one);
			const __m128 invSqrt = one / _mm_sqrt_ps(radicand);

			__m128 zy_xz_yx = SSE_SELECT_F(mask_00f0, _m.cols[1], _m.cols[0]);
			zy_xz_yx = _mm_shuffle_ps(zy_xz_yx, zy_xz_yx, _MM_SHUFFLE(0, 1, 2, 2));
			zy_xz_yx =
				SSE_SELECT_F(mask_0f00, SSE_SPLAT_F(_m.cols[2], 0), zy_xz_yx);
			__m128 yz_zx_xy = SSE_SELECT_F(mask_f000, _m.cols[1], _m.cols[0]);
			yz_zx_xy = _mm_shuffle_ps(yz_zx_xy, yz_zx_xy, _MM_SHUFFLE(0, 0, 2, 0));
			yz_zx_xy =
				SSE_SELECT_F(mask_f000, SSE_SPLAT_F(_m.cols[2], 1), yz_zx_xy);
			...
			__m128 res0 = SSE_SELECT_F(mask_000f, SSE_SPLAT_F(diff, 0), sum0);
			__m128 res1 = SSE_SELECT_F(mask_000f, SSE_SPLAT_F(diff, 1), sum1);
			__m128 res2 = SSE_SELECT_F(mask_000f, SSE_SPLAT_F(diff, 2), sum2);
			res0 = _mm_mul_ps(SSE_SELECT_F(mask_f000, radicand, res0),
				SSE_SPLAT_F(scale, 0));
			res1 = _mm_mul_ps(SSE_SELECT_F(mask_0f00, radicand, res1),
				SSE_SPLAT_F(scale, 1));
			res2 = _mm_mul_ps(SSE_SELECT_F(mask_00f0, radicand, res2),
				SSE_SPLAT_F(scale, 2));
			__m128 res3 = _mm_mul_ps(SSE_SELECT_F(mask_000f, radicand, diff),
				SSE_SPLAT_F(scale, 3));

			const __m128 xx = SSE_SPLAT_F(_m.cols[0], 0);
			const __m128 yy = SSE_SPLAT_F(_m.cols[1], 1);
			const __m128 zz = SSE_SPLAT_F(_m.cols[2], 2);
			...
			const __m128i cond2 = _mm_castps_si128(
				_mm_cmpgt_ps(SSE_SPLAT_F(diag_sum, 0), _mm_castsi128_ps(zero)));
			__m128 res = SSE_SELECT_F(cond0, res1, res0);
			res = SSE_SELECT_F(cond1, res2, res);
			res = SSE_SELECT_F(cond2, res3, res);
			...
			SimdFloat4* _quaternion, SimdFloat4* _scale)
		{
			...
			*_translation = SSE_SELECT_F(fff0, _m.cols[3], one);
			...
			if (mask & 1)
			{
				...
				orthonormal.cols[1] = _mm_div_ps(_m.cols[1], SSE_SPLAT_F(abs_scale, 1));
			...
			else if (mask & 4)
			{
				...
				orthonormal.cols[0] = _mm_div_ps(_m.cols[0], SSE_SPLAT_F(abs_scale, 0));
				orthonormal.cols[2] = Normalize3(Cross3(orthonormal.cols[0], _m.cols[1]));
				orthonormal.cols[1] =
					Normalize3(Cross3(orthonormal.cols[2], orthonormal.cols[0]));
			}
			else
			{  // Favor z axis in the default case
				if (mask & 5)
				{
					return false;
				}
				orthonormal.cols[2] = _mm_div_ps(_m.cols[2], SSE_SPLAT_F(abs_scale, 2));
			...
			const __m128 scale = SSE_SELECT_F(cond, abs_scale, cfalse);
			*_scale = SSE_SELECT_F(fff0, scale, one);
		...
		INLINE Float4x4 Float4x4::FromEuler(_SimdFloat4 _v)
		{
			...
			const Float4x4 ret =
			{
			{simd_float4::Load(cx * cy, sx * sz - cx * sycz,
																 cx * sysz + sx * cz, 0.f),
		...
		INLINE Float4x4 Float4x4::FromAxisAngle(_SimdFloat4 _v)
		{
			...
			const Float4x4 ret =
			{
			{_mm_shuffle_ps(t0, t0, _MM_SHUFFLE(1, 3, 2, 0)),
		...
		INLINE Float4x4 Float4x4::FromQuaternion(_SimdFloat4 _quaternion)
		{
			...
			const Float4x4 ret =
			{
			{_mm_shuffle_ps(q0, q0, _MM_SHUFFLE(1, 3, 2, 0)),
		...
		INLINE egal::math::SimdFloat4 TransformVector(const egal::math::Float4x4& _m,
			egal::math::_SimdFloat4 _v)
		{
			const __m128 vxxxx = SSE_SPLAT_F(_v, 0);
			const __m128 vyyyy = SSE_SPLAT_F(_v, 1);
...
#if !defined(__GNUC__)
INLINE egal::math::SimdFloat4 operator+(egal::math::_SimdFloat4 _a,
	egal::math::_SimdFloat4 _b)
{
...
INLINE egal::math::SimdFloat4 operator-(egal::math::_SimdFloat4 _v)
{
...
INLINE egal::math::SimdFloat4 operator*(const egal::math::Float4x4& _m,
	egal::math::_SimdFloat4 _v)
{
	const __m128 vxxxx = SSE_SPLAT_F(_v, 0);
	const __m128 vyyyy = SSE_SPLAT_F(_v, 1);
	...
	const __m128 m1 = _mm_mul_ps(_m.cols[1], vyyyy);
	const __m128 vzzzz = SSE_SPLAT_F(_v, 2);
	const __m128 vwwww = SSE_SPLAT_F(_v, 3);
	const __m128 a01 = _mm_add_ps(m0, m1);
	const __m128 m2 = _mm_mul_ps(_m.cols[2], vzzzz);
...
{
	egal::math::Float4x4 ret;
	{
		const __m128 vxxxx = SSE_SPLAT_F(_b.cols[0], 0);
		const __m128 vyyyy = SSE_SPLAT_F(_b.cols[0], 1);
		const __m128 m0 = _mm_mul_ps(_a.cols[0], vxxxx);
		const __m128 m1 = _mm_mul_ps(_a.cols[1], vyyyy);
		const __m128 vzzzz = SSE_SPLAT_F(_b.cols[0], 2);
		const __m128 vwwww = SSE_SPLAT_F(_b.cols[0], 3);
		const __m128 a01 = _mm_add_ps(m0, m1);
	...
	{
		const __m128 vxxxx = SSE_SPLAT_F(_b.cols[1], 0);
		const __m128 vyyyy = SSE_SPLAT_F(_b.cols[1], 1);
		const __m128 m0 = _mm_mul_ps(_a.cols[0], vxxxx);
		const __m128 m1 = _mm_mul_ps(_a.cols[1], vyyyy);
		const __m128 vzzzz = SSE_SPLAT_F(_b.cols[1], 2);
		const __m128 vwwww = SSE_SPLAT_F(_b.cols[1], 3);
		const __m128 a01 = _mm_add_ps(m0, m1);
		const __m128 m2 = _mm_mul_ps(_a.cols[2], vzzzz);
		const __m128 m3 = _mm_mul_ps(_a.cols[3], vwwww);
		const __m128 a012 = _mm_add_ps(a01, m2);
	...
	{
		const __m128 vxxxx = SSE_SPLAT_F(_b.cols[2], 0);
		const __m128 vyyyy = SSE_SPLAT_F(_b.cols[2], 1);
		const __m128 m0 = _mm_mul_ps(_a.cols[0], vxxxx);
		const __m128 m1 = _mm_mul_ps(_a.cols[1], vyyyy);
		const __m128 vzzzz = SSE_SPLAT_F(_b.cols[2], 2);
		const __m128 vwwww = SSE_SPLAT_F(_b.cols[2], 3);
		const __m128 a01 = _mm_add_ps(m0, m1);
		const __m128 m2 = _mm_mul_ps(_a.cols[2], vzzzz);
		const __m128 m3 = _mm_mul_ps(_a.cols[3], vwwww);
		const __m128 a012 = _mm_add_ps(a01, m2);
	...
	{
		const __m128 vxxxx = SSE_SPLAT_F(_b.cols[3], 0);
		const __m128 vyyyy = SSE_SPLAT_F(_b.cols[3], 1);
		const __m128 m0 = _mm_mul_ps(_a.cols[0], vxxxx);
		const __m128 m1 = _mm_mul_ps(_a.cols[1], vyyyy);
		const __m128 vzzzz = SSE_SPLAT_F(_b.cols[3], 2);
		const __m128 vwwww = SSE_SPLAT_F(_b.cols[3], 3);
		const __m128 a01 = _mm_add_ps(m0, m1);
		const __m128 m2 = _mm_mul_ps(_a.cols[2], vzzzz);
		const __m128 m3 = _mm_mul_ps(_a.cols[3], vwwww);
		const __m128 a012 = _mm_add_ps(a01, m2);
...
namespace egal
{
	namespace math
	{
		INLINE uint16_t FloatToHalf(float _f)
		{
		...
		INLINE SimdFloat4 HalfToFloat(_SimdInt4 _h)
		{
...
#undef SSE_SPLAT_I
#undef SSE_SELECT_I
#endif  // MATHS_INTERNAL_SIMD_MATH_SSE_INL_H_
