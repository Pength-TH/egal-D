#ifndef MATHS_SIMD_MATH_H_
#define MATHS_SIMD_MATH_H_
#include "common/animation/platform.h"
#include "common/animation/maths/internal/simd_math_config.h"
...
namespace egal
{
	namespace math
	{
		...
		INLINE SimdFloat4 SetI(_SimdFloat4 _v, int _i, float _f);
		...
		// v = (_a * _b) + _addend
		INLINE SimdFloat4 MAdd(_SimdFloat4 _a, _SimdFloat4 _b, _SimdFloat4 _addend);
		...
		INLINE SimdFloat4 Min(_SimdFloat4 _v);
		...
		// Replicates x of _a to all the components of the returned vector.
		INLINE SimdInt4 SplatX(_SimdInt4 _v);

		// Replicates y of _a to all the components of the returned vector.
		INLINE SimdInt4 SplatY(_SimdInt4 _v);

		// Replicates z of _a to all the components of the returned vector.
		INLINE SimdInt4 SplatZ(_SimdInt4 _v);

		// Replicates w of _a to all the components of the returned vector.
		INLINE SimdInt4 SplatW(_SimdInt4 _v);
		...
		struct Float4x4
		{
			...
			// _v.w is ignored.
			static INLINE Float4x4 Translation(_SimdFloat4 _v);

			// Returns a scaling matrix that scales along _v.
			// _v.w is ignored.
			static INLINE Float4x4 Scaling(_SimdFloat4 _v);
...
#if !defined(__GNUC__) || defined(SIMD_REF)
...
INLINE egal::math::SimdFloat4 operator/(egal::math::_SimdFloat4 _a,
	egal::math::_SimdFloat4 _b);
#endif  // !defined(__GNUC__) || defined(SIMD_REF)
...
#include "common/animation/maths/internal/simd_math_sse-inl.h"
#elif defined(SIMD_REF)
#include "common/animation/maths/internal/simd_math_ref-inl.h"
#else
#error No simd_math implementation detected
#endif
#endif  // MATHS_SIMD_MATH_H_
