...
#ifndef MATHS_VEC_FLOAT_H_
#define MATHS_VEC_FLOAT_H_
...
namespace egal
{
	namespace math
	{
		...
		struct Float2
		{
			...
			explicit INLINE Float2(float _f) : x(_f), y(_f)
			{}
		...
		struct Float3
		{
			...
			// Constructs a vector initialized with _f value.
			explicit INLINE Float3(float _f) : x(_f), y(_f), z(_f)
			{}
			...
			INLINE Float3(Float2 _v, float _z) : x(_v.x), y(_v.y), z(_z)
			{}

			// Returns a vector with all components set to 0.
			static INLINE Float3 zero()
			{
		...
		struct Float4
		{
			...
			// Constructs a vector initialized with _f value.
			explicit INLINE Float4(float _f) : x(_f), y(_f), z(_f), w(_f)
			{}
			...
			INLINE Float4(Float3 _v, float _w) : x(_v.x), y(_v.y), z(_v.z), w(_w)
			{}

			// Constructs a vector initialized with _v.x, _v.y, _z and _w values.
			INLINE Float4(Float2 _v, float _z, float _w)
		...
		INLINE Float4 operator+(const Float4& _a, const Float4& _b)
		{
			return Float4(_a.x + _b.x, _a.y + _b.y, _a.z + _b.z, _a.w + _b.w);
		}
		INLINE Float3 operator+(const Float3& _a, const Float3& _b)
		{
			return Float3(_a.x + _b.x, _a.y + _b.y, _a.z + _b.z);
		}
		INLINE Float2 operator+(const Float2& _a, const Float2& _b)
		{
		...
		INLINE Float4 operator-(const Float4& _v)
		{
			return Float4(-_v.x, -_v.y, -_v.z, -_v.w);
		}
		INLINE Float3 operator-(const Float3& _v)
		{
			return Float3(-_v.x, -_v.y, -_v.z);
		}
		INLINE Float2 operator-(const Float2& _v)
		{
		...
		// operator *.
		INLINE Float4 operator*(const Float4& _a, float _f)
		{
			return Float4(_a.x * _f, _a.y * _f, _a.z * _f, _a.w * _f);
		}
		INLINE Float3 operator*(const Float3& _a, float _f)
		{
			return Float3(_a.x * _f, _a.y * _f, _a.z * _f);
		}
		INLINE Float2 operator*(const Float2& _a, float _f)
		{
		...
		INLINE float HAdd(const Float4& _v)
		{
			return _v.x + _v.y + _v.z + _v.w;
		}
		INLINE float HAdd(const Float3& _v)
		{
			return _v.x + _v.y + _v.z;
		}
		INLINE float HAdd(const Float2& _v)
		{
			return _v.x + _v.y;
		}
		...
		INLINE float Dot(const Float2& _a, const Float2& _b)
		{
		...
		INLINE float LengthSqr(const Float4& _v)
		{
			return _v.x * _v.x + _v.y * _v.y + _v.z * _v.z + _v.w * _v.w;
		}
		INLINE float LengthSqr(const Float3& _v)
		{
			return _v.x * _v.x + _v.y * _v.y + _v.z * _v.z;
		}
		INLINE float LengthSqr(const Float2& _v)
		{
			return _v.x * _v.x + _v.y * _v.y;
		}

		// Returns the normalized vector _v.
		INLINE Float4 Normalize(const Float4& _v)
		{
			const float len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z + _v.w * _v.w;
		...
		INLINE Float3 Normalize(const Float3& _v)
		{
			const float len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z;
			assert(len2 != 0.f && "_v is not normalizable");
			const float len = std::sqrt(len2);
		...
		INLINE Float2 Normalize(const Float2& _v)
		{
			const float len2 = _v.x * _v.x + _v.y * _v.y;
			assert(len2 != 0.f && "_v is not normalizable");
			const float len = std::sqrt(len2);
		...
		INLINE bool IsNormalized(const Float4& _v)
		{
			const float len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z + _v.w * _v.w;
			return std::abs(len2 - 1.f) < kNormalizationToleranceSq;
		}
		INLINE bool IsNormalized(const Float3& _v)
		{
			const float len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z;
			return std::abs(len2 - 1.f) < kNormalizationToleranceSq;
		}
		INLINE bool IsNormalized(const Float2& _v)
		{
			const float len2 = _v.x * _v.x + _v.y * _v.y;
			return std::abs(len2 - 1.f) < kNormalizationToleranceSq;
		}
		...
		INLINE Float4 NormalizeSafe(const Float4& _v, const Float4& _safer)
		{
		...
		INLINE Float3 NormalizeSafe(const Float3& _v, const Float3& _safer)
		{
			assert(IsNormalized(_safer) && "_safer is not normalized");
			const float len2 = _v.x * _v.x + _v.y * _v.y + _v.z * _v.z;
			if (len2 <= 0.f)
		...
		INLINE Float2 NormalizeSafe(const Float2& _v, const Float2& _safer)
		{
			assert(IsNormalized(_safer) && "_safer is not normalized");
			const float len2 = _v.x * _v.x + _v.y * _v.y;
			if (len2 <= 0.f)
		...
		INLINE Float4 Lerp(const Float4& _a, const Float4& _b, float _f)
		{
			return Float4((_b.x - _a.x) * _f + _a.x, (_b.y - _a.y) * _f + _a.y,
				(_b.z - _a.z) * _f + _a.z, (_b.w - _a.w) * _f + _a.w);
		}
		INLINE Float3 Lerp(const Float3& _a, const Float3& _b, float _f)
		{
			return Float3((_b.x - _a.x) * _f + _a.x, (_b.y - _a.y) * _f + _a.y,
				(_b.z - _a.z) * _f + _a.z);
		}
		INLINE Float2 Lerp(const Float2& _a, const Float2& _b, float _f)
		{
			return Float2((_b.x - _a.x) * _f + _a.x, (_b.y - _a.y) * _f + _a.y);
		}

		// Returns true if the distance between _a and _b is less than _tolerance.
		INLINE bool Compare(const Float4& _a, const Float4& _b, float _tolerance)
		{
			const math::Float4 diff = _a - _b;
			return Dot(diff, diff) <= _tolerance * _tolerance;
		}
		INLINE bool Compare(const Float3& _a, const Float3& _b, float _tolerance)
		{
			const math::Float3 diff = _a - _b;
			return Dot(diff, diff) <= _tolerance * _tolerance;
		}
		INLINE bool Compare(const Float2& _a, const Float2& _b, float _tolerance)
		{
		...
		INLINE bool operator<(const Float4& _a, const Float4& _b)
		{
			return _a.x < _b.x && _a.y < _b.y && _a.z < _b.z && _a.w < _b.w;
		}
		INLINE bool operator<(const Float3& _a, const Float3& _b)
		{
			return _a.x < _b.x && _a.y < _b.y && _a.z < _b.z;
		}
		INLINE bool operator<(const Float2& _a, const Float2& _b)
		{
			return _a.x < _b.x && _a.y < _b.y;
		}
		...
		INLINE Float4 Min(const Float4& _a, const Float4& _b)
		{
			return Float4(_a.x < _b.x ? _a.x : _b.x, _a.y < _b.y ? _a.y : _b.y,
				_a.z < _b.z ? _a.z : _b.z, _a.w < _b.w ? _a.w : _b.w);
		}
		INLINE Float3 Min(const Float3& _a, const Float3& _b)
		{
			return Float3(_a.x < _b.x ? _a.x : _b.x, _a.y < _b.y ? _a.y : _b.y,
				_a.z < _b.z ? _a.z : _b.z);
		}
		INLINE Float2 Min(const Float2& _a, const Float2& _b)
		{
			return Float2(_a.x < _b.x ? _a.x : _b.x, _a.y < _b.y ? _a.y : _b.y);
		}

		// Returns the maximum of each element of _a and _b.
		INLINE Float4 Max(const Float4& _a, const Float4& _b)
		{
			return Float4(_a.x > _b.x ? _a.x : _b.x, _a.y > _b.y ? _a.y : _b.y,
				_a.z > _b.z ? _a.z : _b.z, _a.w > _b.w ? _a.w : _b.w);
		}
		INLINE Float3 Max(const Float3& _a, const Float3& _b)
		{
			return Float3(_a.x > _b.x ? _a.x : _b.x, _a.y > _b.y ? _a.y : _b.y,
				_a.z > _b.z ? _a.z : _b.z);
		}
		INLINE Float2 Max(const Float2& _a, const Float2& _b)
		{
			return Float2(_a.x > _b.x ? _a.x : _b.x, _a.y > _b.y ? _a.y : _b.y);
		}
		...
		INLINE Float4 Clamp(const Float4& _a, const Float4& _v, const Float4& _b)
		{
			const Float4 _min(_v.x < _b.x ? _v.x : _b.x, _v.y < _b.y ? _v.y : _b.y,
				_v.z < _b.z ? _v.z : _b.z, _v.w < _b.w ? _v.w : _b.w);
			return Float4(_a.x > _min.x ? _a.x : _min.x, _a.y > _min.y ? _a.y : _min.y,
				_a.z > _min.z ? _a.z : _min.z, _a.w > _min.w ? _a.w : _min.w);
		}
		INLINE Float3 Clamp(const Float3& _a, const Float3& _v, const Float3& _b)
		{
			const Float3 _min(_v.x < _b.x ? _v.x : _b.x, _v.y < _b.y ? _v.y : _b.y,
				_v.z < _b.z ? _v.z : _b.z);
			return Float3(_a.x > _min.x ? _a.x : _min.x, _a.y > _min.y ? _a.y : _min.y,
				_a.z > _min.z ? _a.z : _min.z);
		}
		INLINE Float2 Clamp(const Float2& _a, const Float2& _v, const Float2& _b)
		{
			const Float2 _min(_v.x < _b.x ? _v.x : _b.x, _v.y < _b.y ? _v.y : _b.y);
			return Float2(_a.x > _min.x ? _a.x : _min.x, _a.y > _min.y ? _a.y : _min.y);
		}
	}  // namespace math
}  // namespace egal
#endif  // MATHS_VEC_FLOAT_H_
