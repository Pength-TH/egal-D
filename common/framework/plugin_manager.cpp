...
#error Unknown platform
	...
	{
		return _aligned_new(engine.getAllocator(), PluginManagerImpl)(engine, engine.getAllocator());
	}


	void PluginManager::destroy(PluginManager* manager)
	{
		_delete(static_cast<PluginManagerImpl*>(manager)->getAllocator(), manager);
	}
}
